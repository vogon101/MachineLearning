package com.vogonjeltz.machineInt.lib.models

import breeze.linalg.DenseVector
import com.vogonjeltz.machineInt.lib.prediction.StocksPredictor
import com.vogonjeltz.machineInt.lib.{AutoCorrelation, StockHistory}
